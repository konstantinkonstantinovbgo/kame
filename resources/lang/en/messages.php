...
It is critical that designers of both systems collaborate throughout the development process in order to prevent conflicts and ensure alignment between each system prior to design completion.',
    ...
    'automation-production-text-4'        => 'Recent advancements in automation in industrial production are focused on flexibility and quality. Manufacturing flexibility not only allows for more product types, but also lets consumers order customized products that are automatically produced.',
...
Outsourcing mechanical engineering requirements allows companies to stay competitive by optimizing their product engineering and R&D services and shortening product development cycle. Our success stems from the fact that we constantly strive to maximize productivity and deliver unmatched mechanical engineering solutions that are customized, and solve problems effortlessly.',
    ...
    'proj4-tech-data'          => '
        Two 450W Servo Motors with planetary gearheads
        Working loading speed- up to 55 Bottles per minutes
        Robot can handle from 0.185 to 1.5L Bottles
    ',
    ...
    'proj10-tech-data'         => '
        ...
        One 4.5m Active roller conveyer with 0.25KW geared motor driven with double chain
        Three section with pneumatic hard stops
    ',
